...
export class If extends Instruccion {
    ...
    interpretar(arbol: any, tabla: TablaSimbolos): any {
        ...
        if (resultadoCondicion) {
            ...
            if (resultadoIf instanceof Break) return resultadoIf;
            if (resultadoIf instanceof Return) return resultadoIf;
            return null;
        }
        ...
        if (this.bloqueElse != null) {
            ...
            if (resultadoElse instanceof Break) return resultadoElse;
            if (resultadoElse instanceof Return) return resultadoElse;
        }
